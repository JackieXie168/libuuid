...
#  endif
#  ifndef PROG_INF_SH_NM_FROM_FILE
#   define PROG_INF_SH_NM_FROM_FILE
...
# define err(E, FMT, A1, A2, A3) errmsg(1, E, 1, FMT, A1, A2, A3)
# define errx(E, FMT, A1, A2, A3) errmsg(1, E, 0, FMT, A1, A2, A3)
# define warn(FMT, A1, A2, A3) errmsg(0, 0, 1, FMT, A1, A2, A3)
# define warnx(FMT, A1, A2, A3) errmsg(0, 0, 0, FMT, A1, A2, A3)
#endif
#else
